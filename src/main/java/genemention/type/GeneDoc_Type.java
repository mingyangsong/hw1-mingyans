...
public class GeneDoc_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    ...
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (GeneDoc_Type.this.useExistingInstance) {
        ...
        return new GeneDoc(addr, GeneDoc_Type.this);
    }
  };
  ...
  public String getGeneTag(int addr) {
    if (featOkTst && casFeat_GeneTag == null)
      jcas.throwFeatMissing("GeneTag", "genemention.type.GeneDoc");
  ...
  public GeneDoc_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_GeneTag = (null == casFeat_GeneTag) ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_GeneTag).getCode();
